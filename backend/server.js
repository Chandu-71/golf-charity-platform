...
app.get('/api/draws', async (req, res) => {
  try {
    console.log('Attempting to fetch draws from Supabase...');
    // Removing any complex ordering just to ensure basic connectivity
    ...
    console.log(`Successfully fetched ${data?.length || 0} draws.`);
    res.json(data || []);
  } catch (err) {
    console.error('Fatal Server Error in /api/draws:', err);
